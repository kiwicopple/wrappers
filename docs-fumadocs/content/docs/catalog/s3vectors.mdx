---
title: "S3 Vectors"
description: "[AWS S3 Vectors](https://aws.amazon.com/s3/features/vectors/) is a managed service that stores and queries high-dimensional vectors at scale, optimized for mach"
---
