...
description: "This guide will create a GitHub FDW which you can use to query the [GitHub Events API](https://api.github.com/events) using Postgres."
---
...
You can install the FDW on any Postgres [platform that supports](index#supported-platforms) Wrappers `>=0.4.1`.
...
Enable the Wrappers extension and initialize the Wasm FDW on any platform that [supports Wrappers](index#supported-platforms):
