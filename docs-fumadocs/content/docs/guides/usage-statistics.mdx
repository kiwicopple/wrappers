---
title: "FDW Usage Statistics"
description: "Quantitative metrics are useful when working with Postgres FDWs because of their impact on performance optimization, monitoring, and query planning across distr"
---
